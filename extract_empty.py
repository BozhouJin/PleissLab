...
def main():
	...
	for sample in samples:
		...
		EmptyFilter('%s/trimmed/'%(directory),'%s/empty/'%(directory),sample,32)

# This script is the same as remove_umi_extract_empty.py except for that it does not remove umi. This
# is specifically designed for my SPE-seq protocol since it does not contain the UMI in the primer.
# It removes empty reads, which as explained in remove_umi_extract_empty.py, has at most 26bp primer
